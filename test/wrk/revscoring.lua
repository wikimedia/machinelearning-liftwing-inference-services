--[[
     Usage:
          wrk -c 4 -t 2 --timeout 5s -s revscoring.lua \
          https://inference.svc.eqiad.wmnet:30443/v1/models/enwiki-goodfaith:predict \
          --header "Host: enwiki-goodfaith.revscoring-editquality-goodfaith.wikimedia.org" \
          --latency -- enwiki.input
--]]
wrk.method = "POST"
