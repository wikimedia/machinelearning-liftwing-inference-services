...
> [!WARNING]
> The production Blubber image is based on AMD **vLLM 0.22**. Official Jina nano docs
...
> [!NOTE]
> This model-server is designed to be hosted in a custom-built Docker image that supports vLLM 0.22 and can be found here: https://docker-registry.wikimedia.org/ml/amd-vllm022/tags/
>
...
If you are running outside the recommended Docker environment and your system already supports vLLM 0.22, create a virtual environment and install the dependencies using:
```console
python3 -m venv .venv
